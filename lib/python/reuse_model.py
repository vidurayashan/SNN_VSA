...
#         self.run_loihi = run_loihi
    ...
    '''Set Threshold and Timesteps using the resolution and error percentage and max value '''
    def set_params_auto(self, resolution, error, max_val):
        return lib.set_params_auto_custom_max(error_percentage=error, R=resolution, max_val=max_val)
    ...
    def bind(self, v1, v2, debug = False):
        ...
        self.n1.input_vec.set(np.array(v1))
        self.n2.input_vec.set(np.array(v2))
        ...
        return raw_rslt, [voltage_n1, voltage_n2, voltage_mult, voltage_add, voltage_deco_mult, voltage_deco_add]
